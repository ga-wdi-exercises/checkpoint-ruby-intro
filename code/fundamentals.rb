...
def noise.make_noise
  puts noise
end

# 4. Write a method `count_down` which takes one argument and
#prints every number from it to 0. Assume `count_down` will only be called with positive integers
